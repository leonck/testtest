...
public class OptionsAdapter extends BaseAdapter {
	...
	private ArrayList<LoginHistory> list = new ArrayList<LoginHistory>();
	 ...
	 * @param list
	 */
    public OptionsAdapter(Activity activity, Handler handler, ArrayList<LoginHistory> list){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.textView.setText(list.get(position).getHistory());
