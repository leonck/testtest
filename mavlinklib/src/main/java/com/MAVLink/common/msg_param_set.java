...
public class msg_param_set extends MAVLinkMessage{
    ...
    */
    ...
    /**
    * Onboard string type parameter value2,
    */
    public byte param_value2[] = new byte[30];
    ...
    */
    public MAVLinkPacket pack(){
        ...
        for (int i = 0; i < param_value2.length; i++) {
            packet.payload.putByte(param_value2[i]);
        }
    ...
    */
    public void unpack(MAVLinkPayload payload) {
        ...
        for (int i = 0; i < this.param_value2.length; i++) {
            this.param_value2[i] = payload.getByte();
        }
    ...
    */
    public void setParam_Value2(String str) {
        ...
        for (int i=0; i<len; i++) {
            param_value2[i] = (byte) str.charAt(i);
        }
    ...
    */
    public String getParam_Value2() {
        ...
        for (int i = 0; i < 30; i++) {
            if (param_value2[i] != 0)
                result = result + (char) param_value2[i];
            else
                break;
        }
        return result;
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_PARAM_SET -"+" param_value:"+param_value+" target_system:"+target_system+" target_component:"+target_component+" param_id:"+param_id+" param_value2:"+param_value2+" param_type:"+param_type+"";
    }
}
