...
public class WifiAdmin {
    ...
    public WifiAdmin(Context context) {
        // 取得WifiManager对象
        mWifiManager = (WifiManager) HubsanApplication.getApplication()
    ...
    public static String getConnectWifiBSSID() {
        WifiManager wifiManager = (WifiManager) HubsanApplication.getApplication().getSystemService(HubsanApplication.getApplication().WIFI_SERVICE);
        WifiInfo wifiInfo = wifiManager.getConnectionInfo();
        return wifiInfo.getBSSID();
    }
    //判断WIFI是否连接
    public int isWifiContected(Context context) {
        ConnectivityManager connectivityManager = (ConnectivityManager) HubsanApplication.getApplication()
