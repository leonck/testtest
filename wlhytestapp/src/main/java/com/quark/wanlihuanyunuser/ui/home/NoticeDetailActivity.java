...
public class NoticeDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBackButton();
        setTopTitle("详情");
        notices_id = (String) getValue4Intent("notices_id");
        webView = (WebView) findViewById(R.id.web);
        webSettings = webView.getSettings();
//        h5Request();
        String url = ApiHttpClient.HOSTURL + "/app/CommonManage/noticeDetailH5?notices_id=" + notices_id
                + "&token=" + new AppParam().getToken(this) + "&user_type=1";
        showWebInfo(url);
        MainActivity.instance.hiteNotice();
    }
