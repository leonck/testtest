...
public class msg_param_value extends MAVLinkMessage{
    ...
    */
    public String toString(){
        return "MAVLINK_MSG_ID_PARAM_VALUE -"+" param_value:"+param_value+" param_count:"+param_count+" param_index:"+param_index+" param_id:"+param_id+" param_value2:"+param_value2+" param_type:"+param_type+"";
    }
}
