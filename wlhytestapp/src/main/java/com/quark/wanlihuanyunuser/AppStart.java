...
import com.quark.wanlihuanyunuser.ui.user.GuidePgActivity;
import com.quark.wanlihuanyunuser.util.TDevice;
...
//        startService(uploadLog);
        if (new AppParam().isLogin(this)){
            ...
            Intent intent = new Intent(this, GuidePgActivity.class);
            startActivity(intent);
        }
        finish();
    }
