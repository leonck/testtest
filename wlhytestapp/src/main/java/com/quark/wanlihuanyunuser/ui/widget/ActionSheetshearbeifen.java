...
@SuppressLint("NewApi")
public class ActionSheetshearbeifen {
    ...
    private ActionSheetshearbeifen() {
    }
    ...
    public static Dialog showSheetSex(final Context context, OnCancelListener cancelListener, final Handler handler) {
        ...
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.actionsheetshearbeifen, null);
